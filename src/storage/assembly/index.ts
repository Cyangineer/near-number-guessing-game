import { context, u128, PersistentMap, logging, RNG } from "near-sdk-as"
...
export function createGame(): u32 {
    ...
    logging.log("Game ID: " + game.id.toString())
    return game.id
}
        ...
        if (game.gameState == GameState.Created) {
            ...
            if (context.sender == game.player1) {
                ...
                if (guess == selectedNum) {
                    ...
                    games.set(gameId, game)
                    logging.log("You lost. The number was " + selectedNum.toString())
                    return "lost"
                }
            }
            return "Wrong player."
